  ...
  return (
    <div
      className={`rounded-xl2 px-5 py-4 text-center font-bold text-2xl tabular-nums ${
        overdue ? "bg-brand-coral/10 text-brand-coral" : "bg-brand-leaf/10 text-brand-leaf"
      }`}
    >
      {overdue ? "Overdue " : ""}
...
export default function ConfirmationScreen({
  ...
  return (
    <div className="bg-white rounded-xl2 shadow-sm p-8 text-center">
      ...
      <h1 className="text-2xl font-bold text-brand-ink mb-1">You're checked in!</h1>
      <p className="text-brand-ink/60 mb-6">Show this screen at the front desk.</p>
